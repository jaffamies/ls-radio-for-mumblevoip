...
mumbleConfig = {
    ...
    voiceModes = {
        {2.5, "Kuiskaus"}, -- Whisper speech distance in gta distance units
        {8.0, "Normaali"}, -- Normal speech distance in gta distance units
        {20.0, "Huuto"}, -- Shout speech distance in gta distance units
    },
